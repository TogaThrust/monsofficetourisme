/**
 * Bump version + SW + notes after fill-mortier-pilon.mjs.
 * Lit les numéros RÉELS, +1. Usage: node scripts/bump-mortier-pilon.mjs
 */
import fs from 'fs';
...
const block =
  ...
  `Version ${nextVer}\r\n` +
  '----------------------------------------\r\n' +
  'Mortier et Pilon : texte long réécrit (sans répéter le court), 10 langues + audio long.\r\n\r\n';
