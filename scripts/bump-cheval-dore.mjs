/**
 * Bump version + SW + notes after fill-cheval-dore.mjs.
 * Lit les numéros RÉELS, +1. Usage: node scripts/bump-cheval-dore.mjs
 */
import fs from 'fs';
...
const block =
  ...
  `Version ${nextVer}\r\n` +
  '----------------------------------------\r\n' +
  'Cheval Dore : texte long réécrit (sans répéter le court), 10 langues + audio long.\r\n\r\n';
