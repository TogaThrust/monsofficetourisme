/**
 * Bump version + SW + notes after fill-bonne-femme.mjs.
 * Lit les numéros RÉELS, +1. Usage: node scripts/bump-bonne-femme.mjs
 */
import fs from 'fs';
...
const block =
  ...
  `Version ${nextVer}\r\n` +
  '----------------------------------------\r\n' +
  'A la Bonne Femme : texte long réécrit (sans répéter le court), 10 langues + audio long.\r\n\r\n';
