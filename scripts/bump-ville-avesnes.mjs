/**
 * Bump version + SW + notes after fill-ville-avesnes.mjs.
 * Lit les numéros RÉELS, +1. Usage: node scripts/bump-ville-avesnes.mjs
 */
import fs from 'fs';
...
const block =
  ...
  `Version ${nextVer}\r\n` +
  '----------------------------------------\r\n' +
  "A la Ville d'Avesnes : texte long réécrit (sans répéter le court), 10 langues + audio long.\r\n\r\n";
