/**
 * Bump version + SW + notes after fill-le-gant.mjs.
 * Lit les numéros RÉELS, +1. Usage: node scripts/bump-le-gant.mjs
 */
import fs from 'fs';
...
const block =
  ...
  `Version ${nextVer}\r\n` +
  '----------------------------------------\r\n' +
  'Le Gant : texte long réécrit (sans répéter le court), 10 langues + audio long.\r\n\r\n';
