/**
 * Bump version + SW + notes after fill-croix-plume-pinceau.mjs.
 * Lit les numéros RÉELS, +1. Usage: node scripts/bump-croix-plume-pinceau.mjs
 */
import fs from 'fs';
...
const block =
  ...
  `Version ${nextVer}\r\n` +
  '----------------------------------------\r\n' +
  'Croix plume et pinceau : texte long réécrit (sans répéter le court), 10 langues + audio long.\r\n\r\n';
