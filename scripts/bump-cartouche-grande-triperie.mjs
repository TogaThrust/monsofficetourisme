/**
 * Bump version + SW + notes after fill-cartouche-grande-triperie.mjs.
 * Lit les numéros RÉELS, +1. Usage: node scripts/bump-cartouche-grande-triperie.mjs
 */
import fs from 'fs';
...
const block =
  ...
  `Version ${nextVer}\r\n` +
  '----------------------------------------\r\n' +
  'Cartouche et blason Grande Triperie : texte long réécrit (sans répéter le court), 10 langues + audio long.\r\n\r\n';
