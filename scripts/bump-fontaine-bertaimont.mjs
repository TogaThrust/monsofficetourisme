/**
 * Bump version + SW + notes after fill-fontaine-bertaimont.mjs.
 * Lit les numéros RÉELS, +1. Usage: node scripts/bump-fontaine-bertaimont.mjs
 */
import fs from 'fs';
...
const block =
  ...
  `Version ${nextVer}\r\n` +
  '----------------------------------------\r\n' +
  'Fontaine Rue de Bertaimont : texte long réécrit (sans répéter le court), 10 langues + audio long.\r\n\r\n';
