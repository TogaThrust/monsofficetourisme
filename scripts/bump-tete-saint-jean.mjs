/**
 * Bump version + SW + notes after fill-tete-saint-jean.mjs.
 * Lit les numéros RÉELS, +1. Usage: node scripts/bump-tete-saint-jean.mjs
 */
import fs from 'fs';
...
const block =
  ...
  `Version ${nextVer}\r\n` +
  '----------------------------------------\r\n' +
  'A la Tete Saint-Jean : texte long réécrit (sans répéter le court), TETE/Taette lus Tête et Clef lu Clé en TTS, quiz XVIIIe, 10 langues + audio long.\r\n\r\n';
