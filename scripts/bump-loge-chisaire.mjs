/**
 * Bump version + SW + notes after fill-loge-chisaire.mjs.
 * Lit les numéros RÉELS, +1. Usage: node scripts/bump-loge-chisaire.mjs
 */
import fs from 'fs';
...
const block =
  ...
  `Version ${nextVer}\r\n` +
  '----------------------------------------\r\n' +
  'Loge maconnique Rue Chisaire : texte long réécrit (sans répéter le court), 10 langues + audio long.\r\n\r\n';
