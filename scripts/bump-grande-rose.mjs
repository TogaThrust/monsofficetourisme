/**
 * Bump version + SW + notes after fill-grande-rose.mjs.
 * Lit les numéros RÉELS, +1. Usage: node scripts/bump-grande-rose.mjs
 */
import fs from 'fs';
...
const block =
  ...
  `Version ${nextVer}\r\n` +
  '----------------------------------------\r\n' +
  'A la Grande Rose : texte long réécrit (sans répéter le court), 10 langues + audio long.\r\n\r\n';
