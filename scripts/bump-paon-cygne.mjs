/**
 * Bump version + SW + notes after fill-paon-cygne.mjs.
 * Lit les numéros RÉELS, +1. Usage: node scripts/bump-paon-cygne.mjs
 */
import fs from 'fs';
...
const block =
  ...
  `Version ${nextVer}\r\n` +
  '----------------------------------------\r\n' +
  'Au Paon et au Cygne : texte long réécrit (sans répéter le court), 10 langues + audio long.\r\n\r\n';
