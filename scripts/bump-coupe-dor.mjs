/**
 * Bump version + SW + notes after fill-coupe-dor.mjs.
 * Lit les numéros RÉELS, +1. Usage: node scripts/bump-coupe-dor.mjs
 */
import fs from 'fs';
...
const block =
  ...
  `Version ${nextVer}\r\n` +
  '----------------------------------------\r\n' +
  "A la Coupe d'Or : texte long réécrit (sans répéter le court), 10 langues + audio long.\r\n\r\n";
