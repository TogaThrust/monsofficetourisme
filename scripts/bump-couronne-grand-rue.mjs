/**
 * Bump version + SW + notes after fill-couronne-grand-rue.mjs.
 * Lit les numéros RÉELS, +1. Usage: node scripts/bump-couronne-grand-rue.mjs
 */
import fs from 'fs';
...
const block =
  ...
  `Version ${nextVer}\r\n` +
  '----------------------------------------\r\n' +
  'A la Couronne Grand Rue : texte long réécrit (sans répéter le court), 10 langues + audio long.\r\n\r\n';
