/**
 * Bump version + SW + notes after fill-chateau-marcote.mjs.
 * Lit les numéros RÉELS, +1. Usage: node scripts/bump-chateau-marcote.mjs
 */
import fs from 'fs';
...
const block =
  ...
  `Version ${nextVer}\r\n` +
  '----------------------------------------\r\n' +
  'Chateau de le Marcote : texte long réécrit (sans répéter le court), 10 langues + audio long.\r\n\r\n';
