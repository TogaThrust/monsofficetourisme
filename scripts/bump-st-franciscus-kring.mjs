/**
 * Bump version + SW + notes after fill-st-franciscus-kring.mjs.
 * Lit les numéros RÉELS, +1. Usage: node scripts/bump-st-franciscus-kring.mjs
 */
import fs from 'fs';
...
const block =
  ...
  `Version ${nextVer}\r\n` +
  '----------------------------------------\r\n' +
  'St Franciscus Kring : texte long réécrit (sans répéter le court), 10 langues + audio long.\r\n\r\n';
