/**
 * Bump version + SW + notes after fill-cantoria-lassus.mjs.
 * Lit les numéros RÉELS, +1. Usage: node scripts/bump-cantoria-lassus.mjs
 */
import fs from 'fs';
...
const block =
  ...
  `Version ${nextVer}\r\n` +
  '----------------------------------------\r\n' +
  'Cantoria Roland de Lassus : texte long réécrit (sans répéter le court), 10 langues + audio long.\r\n\r\n';
