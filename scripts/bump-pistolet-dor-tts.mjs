/**
 * Bump version + SW + notes after regen-pistolet-dor-tts.mjs.
 * Lit les numéros RÉELS, +1. Usage: node scripts/bump-pistolet-dor-tts.mjs
 */
import fs from 'fs';
...
const block =
  ...
  `Version ${nextVer}\r\n` +
  '----------------------------------------\r\n' +
  "Au Pistolet d'Or : « avec le n°33 » lu « au numéro 33 » (TTS).\r\n\r\n";
