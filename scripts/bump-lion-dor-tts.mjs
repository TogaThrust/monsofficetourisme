/**
 * Bump version + SW + notes after regen-lion-dor-tts.mjs.
 * Lit les numéros RÉELS, +1. Usage: node scripts/bump-lion-dor-tts.mjs
 */
import fs from 'fs';
...
const block =
  ...
  `Version ${nextVer}\r\n` +
  '----------------------------------------\r\n' +
  "Au Lion d'Or et Millesime MDCCXII : n°40 / n°50 lus numéro 40 / numéro 50 (TTS).\r\n\r\n";
