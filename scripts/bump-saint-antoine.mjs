/**
 * Bump version + SW + notes after fill-saint-antoine.mjs.
 * Lit les numéros RÉELS, +1. Usage: node scripts/bump-saint-antoine.mjs
 */
import fs from 'fs';
...
const block =
  ...
  `Version ${nextVer}\r\n` +
  '----------------------------------------\r\n' +
  'A Saint-Antoine : texte long réécrit (sans répéter le court), 10 langues + audio long.\r\n\r\n';
