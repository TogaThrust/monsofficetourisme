/**
 * Bump version + SW + notes after fill-bf-ihs-il.mjs.
 * Lit les numéros RÉELS, +1. Usage: node scripts/bump-bf-ihs-il.mjs
 */
import fs from 'fs';
...
const block =
  ...
  `Version ${nextVer}\r\n` +
  '----------------------------------------\r\n' +
  'BF IHS IL : texte long réécrit (sans répéter le court), IHS lu I H S, 10 langues + audio long.\r\n\r\n';
