/**
 * Bump version + SW + notes after fill-litterature-montoise.mjs.
 * Lit les numéros RÉELS, +1. Usage: node scripts/bump-litterature-montoise.mjs
 */
import fs from 'fs';
...
const block =
  ...
  `Version ${nextVer}\r\n` +
  '----------------------------------------\r\n' +
  'Bas-relief litterature montoise : texte long réécrit (sans répéter le court), 10 langues + audio long.\r\n\r\n';
