/**
 * Bump version + SW + notes after fill-buste-astrid.mjs.
 * Lit les numéros RÉELS, +1. Usage: node scripts/bump-astrid.mjs
 */
import fs from 'fs';
...
const block =
  ...
  `Version ${nextVer}\r\n` +
  '----------------------------------------\r\n' +
  'Buste de la reine Astrid : texte long réécrit (sans répéter le court), 10 langues + audio long.\r\n\r\n';
...
copyViaTmp(
  path.join(ROOT, 'images/Buste_de_la_reine_Astrid.jpg'),
  path.join(ROOT, 'dist/images/Buste_de_la_reine_Astrid.jpg'),
);
