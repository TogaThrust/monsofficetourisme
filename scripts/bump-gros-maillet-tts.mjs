/**
 * Bump version + SW + notes after regen-gros-maillet-tts.mjs.
 * Lit les numéros RÉELS, +1. Usage: node scripts/bump-gros-maillet-tts.mjs
 */
import fs from 'fs';
...
const block =
  ...
  `Version ${nextVer}\r\n` +
  '----------------------------------------\r\n' +
  'Le Gros Maillet : IHS lu I H S, n° 71 et 89 lu numéros (TTS).\r\n\r\n';
